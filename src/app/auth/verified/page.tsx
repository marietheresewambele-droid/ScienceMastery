...
export default function VerifiedPage() {
  ...
  if (state === "checking") return <AuthLayout eyebrow="Confirming your account" title="Verifying your email" description="Please wait while BrainSoma securely activates your account."><div className="h-2 overflow-hidden rounded-full border-2 border-ink bg-cream-soft"><div className="h-full w-1/2 animate-pulse rounded-full bg-orange" /></div></AuthLayout>;
  ...
  return <AuthLayout eyebrow="Account ready" title="Email verified" description="Your BrainSoma account is active. Your progress can now stay linked to your account."><Link className={`${primaryButtonClass} block text-center`} href="/dashboard">Start learning</Link></AuthLayout>;
}
