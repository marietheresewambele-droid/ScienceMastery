...
export const physicsParticleModelOfMatterConfig: PhysicsTopicConfig={ id:"particle-model-of-matter", title:"Particle Model of Matter", description:"Master density, particle behaviour, internal energy, changes of state and gas pressure.", route:"/physics/particle-model-of-matter", storageNamespace:"brainsoma_physics_particle_model_of_matter", questions:physicsParticleModelOfMatterQuestions, subtopics:createPhysicsSubtopics(data), subject:"physics", examBoard:"AQA", topicNumber:"Topic 3" };
