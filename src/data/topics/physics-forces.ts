...
export const physicsForcesConfig: PhysicsTopicConfig={ id:"forces", title:"Forces", description:"Practise interactions, elasticity, moments, pressure, motion, momentum and force calculations.", route:"/physics/forces", storageNamespace:"brainsoma_physics_forces", questions:physicsForcesQuestions, subtopics:createPhysicsSubtopics(data), subject:"physics", examBoard:"AQA", topicNumber:"Topic 5" };
