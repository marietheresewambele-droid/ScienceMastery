...
export const physicsMagnetismAndElectromagnetismConfig: PhysicsTopicConfig={ id:"magnetism-and-electromagnetism", title:"Magnetism and Electromagnetism", description:"Review magnetic fields, the motor effect, induction, generators and transformers.", route:"/physics/magnetism-and-electromagnetism", storageNamespace:"brainsoma_physics_magnetism_and_electromagnetism", questions:physicsMagnetismAndElectromagnetismQuestions, subtopics:createPhysicsSubtopics(data), subject:"physics", examBoard:"AQA", topicNumber:"Topic 7" };
